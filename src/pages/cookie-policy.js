...
const CookiePolicyPage = () => (
    <Layout>
        ...
        <div className="Container w-960 my-5">
            <div className="Group">
            <p>This Cookie Policy explains how GetBamboo ("<strong>Company</strong>", "<strong>we</strong>", "<strong>us</strong>", and "<strong>our</strong>") uses cookies and similar technologies to recognize you when you visit our websites at https://www.getbamboo.co.uk, ("<strong>Websites</strong>"). It explains what these technologies are and why we use them, as well as your rights to control our use of them.</p>
        ...
        <div className="Container w-960 my-5">
            <div className="Group">
                ...
                <p>Cookies set by the website owner (in this case, GetBamboo) are called "first party cookies". Cookies set by parties other than the website owner are called "third party cookies". Third party cookies enable third party features or functionality to be provided on or through the website (e.g. like advertising, interactive content and analytics). The parties that set these third party cookies can recognize your computer both when it visits the website in question and also when it visits certain other websites.</p>
            </div>
        </div>
        <hr></hr>
        <div className="Container w-960 my-5">
            ...
            <div className="Group">
                ...
                <div className="Card mb-4">
                  <div className="CardContent">
                    <p className="mb-2">Name: __tlbcpv</p>
                    <p className="mb-2">Purpose: Used to record unique visitor views of the consent banner.</p>
                    <p className="mb-2">Provider: .termly.io</p>
                    <p className="mb-2">Service: Termly <a href="https://termly.io/our-privacy-policy/">View Service Privacy Policy</a></p>
                    <p className="mb-2">Country: United States</p>
                    <p className="mb-2">Type: http_cookie</p>
                    <p className="mb-0">Expires in: 1 year</p>
                  </div>
                </div>
                <div className="Card mb-4">
                  <div className="CardContent">
                    ...
                    <p className="mb-2">Type: server_cookie</p>
                    <p className="mb-0">Expires in: 30 days</p>
                  </div>
                </div>
            </div>
        </div>
            ...
            <div className="Group">
                ...
                <div className="Card mb-4">
                  <div className="CardContent">
                    ...
                    <p className="mb-2">Country: United States</p>
                    <p className="mb-2">Type: http_cookie</p>
                    <p className="mb-0">Expires in: 1 minute</p>
                  </div>
                </div>
                <div className="Card mb-4">
                  <div className="CardContent">
                    <p className="mb-2">Name: _ga</p>
                    <p className="mb-2">Purpose: It records a particular ID used to come up with data about website usage by the user. It is a HTTP cookie that expires after 2 years.</p>
                    <p className="mb-2">Provider:.getbamboo.co.uk</p>
                    <p className="mb-2">Service: Google Analytics <a href="https://policies.google.com/privacy">View Service Privacy Policy</a></p>
                    <p className="mb-2">Country: United States</p>
                    <p className="mb-2">Type: http_cookie</p>
                    <p className="mb-0">Expires in: 1 year 11 months 29 days</p>
                  </div>
                </div>
                <div className="Card mb-4">
                  <div className="CardContent">
                    <p className="mb-2">Name: _gid</p>
                    <p className="mb-2">Purpose: Keeps an entry of unique ID which is then used to come up with statistical data on website usage by visitors. It is a HTTP cookie type and expires after a browsing session.</p>
                    <p className="mb-2">Provider:.getbamboo.co.uk</p>
                    <p className="mb-2">Service: Google Analytics <a href="https://policies.google.com/privacy">View Service Privacy Policy</a></p>
                    <p className="mb-2">Country: United States</p>
                    <p className="mb-2">Type: http_cookie</p>
                    <p className="mb-0">Expires in: 1 day</p>
                  </div>
                </div>
            </div>
        </div>
        ...
        <div className="Container w-960 my-5">
            <div className="Group">
                ...
                <div className="Card mb-4">
                  <div className="CardContent">
                    <p className="mb-2">Name: _lr_id_</p>
                    <p className="mb-2">Purpose: __________</p>
                    <p className="mb-2">Provider: www.getbamboo.co.uk</p>
                    <p className="mb-2">Service: __________</p>
                    <p className="mb-2">Country: United States</p>
                    <p className="mb-2">Type: html_local_storage</p>
                    <p className="mb-0">Expires in: persistent</p>
                  </div>
                </div>
                <div className="Card mb-4">
                  <div className="CardContent">
                    <p className="mb-2">Name: _lr_hb_ - qbfdxd % 2Fgetbamboo</p>
                    <p className="mb-2">__________</p>
                    <p className="mb-2">Provider: www.getbamboo.co.uk</p>
                    <p className="mb-2">Service: __________</p>
                    <p className="mb-2">Country: United States</p>
                    <p className="mb-2">Type: http_cookie</p>
                ...
                <div className="Card mb-4">
                  <div className="CardContent">
                    <p className="mb-2">Name: _lr_uf_ - qbfdxd</p>
                    <p className="mb-2">__________</p>
                    <p className="mb-2">Provider: www.getbamboo.co.uk</p>
                    <p className="mb-2">Service: __________</p>
                    <p className="mb-2">Country: United States</p>
                    <p className="mb-2">Type: http_cookie</p>
                    <p className="mb-0">Expires in: session</p>
                  </div>
                </div>
                <div className="Card mb-4">
                  <div className="CardContent">
                    <p className="mb-2">Name: _lr_tabs_ - qbfdxd % 2Fgetbamboo</p>
                    <p className="mb-2">__________</p>
                    <p className="mb-2">Provider: www.getbamboo.co.uk</p>
                    <p className="mb-2">Service: __________</p>
                    <p className="mb-2">Country: United States</p>
        ...
        <div className="Container w-960 my-5">
            <div className="Group pb-5">
                ...
                <br></br>
                <p>If you have any questions about our use of cookies or other technologies, please email us at support@getbamboo.co.uk.</p>
            </div>
        </div>
