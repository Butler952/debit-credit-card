  ...
  <Layout>
    ...
    <div className="Container w-960 my-5" >
      <div className="Group">
        ...
        <br></br>
        <p>1.1  These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (you), and GetBamboo (we, us), concerning your access to and use of the Bamboo (https://www.getbamboo.co.uk) website as well as any related applications (the Site).</p>
        <p>The Site provides the following services: <strong>To promote and assess interest for the Bamboo card</strong>. You agree that by accessing the Site and/or Services, you have read, understood, and agree to be bound by all of these Terms and Conditions.</p>
        ...
        <ul>
          <li><p>Our <Link to="/privacy-policy/">Privacy Notice</Link>, which sets out the terms on which we process any personal data we collect from you, or that you provide to us. By using the Site, you consent to such processing and you warrant that all data provided by you is accurate. </p></li>
          <li><p>Our <Link to="/cookie-policy/">Cookie Policy</Link>, which sets out information about the cookies on the Site.</p></li>
        </ul>
      </div>
    </div >
    <hr></hr>
    ...
    <div className="Container w-960 my-5">
      <div className="Group pb-5">
        ...
        <p>8.10  In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us by email at support@getbamboo.co.uk</p>
      </div>
    </div>
